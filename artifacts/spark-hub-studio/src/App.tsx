        ...
        */}
        ...
        <PageFrame className="relative z-10 min-h-0 md:min-h-[580px] lg:min-h-[660px] pb-10 pt-20 md:pb-20 md:pt-28 md:grid md:grid-cols-[1.1fr_.9fr] md:items-center md:gap-8">
          <div className="animate-rise">
            ...
            <h1 className="display max-w-4xl text-[clamp(4.2rem,10.2vw,9.5rem)] font-extrabold leading-[0.92] sm:leading-[0.86] md:leading-[0.82] tracking-[-0.05em] text-foreground">
              <span className="hero-line block pt-2 pb-1">
                <span className="hero-word hero-word-1 inline-block">
                  Where
                </span>
              </span>

              <span className="hero-line block pt-1 pb-1">
