...
export function FloatingWhatsApp() {
  ...
  return (
    <div
      className="fixed bottom-6 right-6 md:bottom-8 md:right-8 z-50 flex flex-col items-center select-none"
    ...
    >
      ...
      >
        ...
        {/* Sleek Dark Pill Label (as shown in reference image) */}
        <div className="relative z-10 -mt-2.5 rounded-full border border-primary/50 bg-[#070b12]/95 px-3 py-1 text-center shadow-[0_4px_12px_rgba(0,0,0,0.7)] backdrop-blur-md transition-all duration-300 group-hover:border-primary group-hover:shadow-[0_0_15px_rgba(233,190,88,0.4)]">
          <span className="mono text-[11px] font-semibold text-white/95 group-hover:text-primary transition-colors whitespace-nowrap">
