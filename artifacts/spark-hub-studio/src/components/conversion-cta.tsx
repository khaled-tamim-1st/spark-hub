        ...
        <div className="relative overflow-hidden rounded-[2rem] md:rounded-[2.5rem] bg-gradient-to-br from-[#8f6217] via-[#b88628] to-[#e5b95c] p-8 sm:p-12 md:p-16 lg:p-20 shadow-[0_25px_60px_-15px_rgba(184,134,40,0.35)] border border-[#fff3d1]/30">
          ...
          >
            <svg
              ...
              preserveAspectRatio={isRTL ? 'xMinYMid meet' : 'xMaxYMid meet'}
            ...
            >
              <defs>
                <radialGradient
                  ...
                  gradientTransform={`translate(${isRTL ? 180 : 620} 250) rotate(90) scale(240)`}
                >
              ...
              {/* Concentric layered rings in champagne light */}
              <circle cx={isRTL ? 180 : 620} cy="250" r="420" fill="white" fillOpacity="0.04" />
              <circle cx={isRTL ? 180 : 620} cy="250" r="350" fill="white" fillOpacity="0.07" />
              <circle cx={isRTL ? 180 : 620} cy="250" r="280" fill="white" fillOpacity="0.11" />
              <circle cx={isRTL ? 180 : 620} cy="250" r="215" fill="white" fillOpacity="0.17" />
              <circle cx={isRTL ? 180 : 620} cy="250" r="155" fill="white" fillOpacity="0.25" />
              <circle cx={isRTL ? 180 : 620} cy="250" r="105" fill="white" fillOpacity="0.38" />
              <circle cx={isRTL ? 180 : 620} cy="250" r="60" fill="white" fillOpacity="0.65" />
              <circle cx={isRTL ? 180 : 620} cy="250" r="28" fill="white" fillOpacity="0.95" />
              <circle cx={isRTL ? 180 : 620} cy="250" r="250" fill="url(#sparkCtaGlow)" />
            </svg>
          </div>
          ...
          <div className="relative z-10 max-w-2xl text-start">
            <h2
              className="text-3xl sm:text-4xl md:text-5xl lg:text-[54px] font-black tracking-[-0.03em] rtl:tracking-normal text-[#0c121e] leading-[1.12] rtl:leading-[1.25] text-balance"
            ...
            <p
              className="mt-4 sm:mt-5 text-base sm:text-lg md:text-xl font-medium text-[#162133] leading-relaxed rtl:leading-[1.8] max-w-xl text-pretty"
              style={{ fontFamily: "'Tajawal', sans-serif" }}
            >
